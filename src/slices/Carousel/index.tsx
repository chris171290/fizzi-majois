  ...
  return (
    ...
    >
      ...
      <div className='grid grid-cols-[auto,auto,auto] items-center'>
        ...
        {/* 3d Can */}
        <View className='aspect-square h-[70vmin], min-h-96'>
          <Center position={[0, 0, 1.5]}>
            <FloatingCan ref={sodaCanRef} floatingIntensity={0.3} rotationIntensity={1} flavor={FLAVORS[currentFlavorIndex].flavor}/>
          </Center>
